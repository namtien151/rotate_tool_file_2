...
class ResultTurnDialog extends StackedView<ResultTurnDialogModel> {
            ...
            Row(
              children: [
                ...
                if (viewModel.filePath!.isNotEmpty &&
                    File(viewModel.filePath!).existsSync())
                  Row(
                    children: [
                      ...
                      SizedBox(
                        ...
                        height: MediaQuery.of(context).size.height * 0.7,
                        child:
                            viewModel.filePath!.toLowerCase().endsWith('.pdf')
  ...
  @override
  ResultTurnDialogModel viewModelBuilder(BuildContext context) =>
      ResultTurnDialogModel(context);
  @override
