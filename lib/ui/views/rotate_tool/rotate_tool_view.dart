...
import '../../widget/normal/button_evaletd.dart';
import '../../widget/normal/dropdow.dart';
import '../../widget/normal/text_model.dart';
import 'rotate_tool_viewmodel.dart';

class RotateToolView extends StackedView<RotateToolViewmodel> {
  const RotateToolView({Key? key}) : super(key: key);

  @override
  Widget builder(
    BuildContext context,
    RotateToolViewmodel viewModel,
    Widget? child,
  ) {
    return Scaffold(
      body: Column(
                                    ...
                                    if (viewModel.showDeleteButton)
                                      SizedBox(
                                        ...
                                        child: CustomElevatedButton(
                                          ...
                                          label:
                                              'Delete All', // Nhãn hiển thị trên nút
                                          icon: Icons
  ...
  @override
  RotateToolViewmodel viewModelBuilder(
    BuildContext context,
  ) =>
     RotateToolViewmodel(context);
}
