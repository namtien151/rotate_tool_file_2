...
public:
    ...
    explicit font_info_private(FontInfo *fi) : type((font_info::type_enum) fi->getType()),
...
public:
    font_iterator_private(int start_page, document_private *dd) : font_info_scanner(dd->doc,
                                                                                    start_page),
                                                                  total_pages(
                                                                          dd->doc->getNumPages()),
                                                                  current_page(
