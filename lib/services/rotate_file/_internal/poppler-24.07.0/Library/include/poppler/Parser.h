...
public:
    ...
    // streams).
    Object getObj(bool simpleOnly = false, const unsigned char *fileKey = nullptr,
                  CryptAlgorithm encAlgorithm = cryptRC4, int keyLength = 0, int objNum = 0,
                  int objGen = 0, int recursion = 0, bool strict = false,
...
private:
    ...
    Stream *makeStream(Object &&dict, const unsigned char *fileKey, CryptAlgorithm encAlgorithm,
                       int keyLength, int objNum, int objGen, int recursion, bool strict);
