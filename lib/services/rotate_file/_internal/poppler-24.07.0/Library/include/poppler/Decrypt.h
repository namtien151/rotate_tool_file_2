...
public:
    ...
    static bool
    makeFileKey(int encVersion, int encRevision, int keyLength, const GooString *ownerKey,
                const GooString *userKey, const GooString *ownerEnc, const GooString *userEnc,
...
private:
    static bool
    makeFileKey2(int encVersion, int encRevision, int keyLength, const GooString *ownerKey,
                 const GooString *userKey, int permissions, const GooString *fileID,
...
public:
    BaseCryptStream(Stream *strA, const unsigned char *fileKey, CryptAlgorithm algoA, int keyLength,
                    Ref ref);
...
public:
    EncryptStream(Stream *strA, const unsigned char *fileKey, CryptAlgorithm algoA, int keyLength,
                  Ref ref);
...
public:
    DecryptStream(Stream *strA, const unsigned char *fileKey, CryptAlgorithm algoA, int keyLength,
                  Ref ref);
