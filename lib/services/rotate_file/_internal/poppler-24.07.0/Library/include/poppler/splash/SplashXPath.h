...
public:
    ...
    // subpaths.
    SplashXPath(SplashPath *path, SplashCoord *matrix, SplashCoord flatness, bool closeSubpaths,
...
protected:
    void transform(SplashCoord *matrix, SplashCoord xi, SplashCoord yi, SplashCoord *xo,
                   SplashCoord *yo);
    ...
    void addCurve(SplashCoord x0, SplashCoord y0, SplashCoord x1, SplashCoord y1, SplashCoord x2,
                  SplashCoord y2, SplashCoord x3, SplashCoord y3, SplashCoord flatness, bool first,
                  bool last, bool end0, bool end1);
