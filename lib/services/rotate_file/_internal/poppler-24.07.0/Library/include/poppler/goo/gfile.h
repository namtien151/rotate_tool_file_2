...
extern GooString POPPLER_PRIVATE_EXPORT
*
...
extern int POPPLER_PRIVATE_EXPORT

openFileDescriptor(const char *path, int flags);
...
// calls fopen.
extern FILE POPPLER_PRIVATE_EXPORT
*
...
extern Goffset POPPLER_PRIVATE_EXPORT
Gftell(FILE
*f);
