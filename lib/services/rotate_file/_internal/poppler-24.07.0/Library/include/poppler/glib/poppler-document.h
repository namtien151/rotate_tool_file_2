...
POPPLER_PUBLIC
PopplerDocument *
poppler_document_new_from_file(const char *uri, const char *password, GError **error);

POPPLER_PUBLIC
PopplerDocument *
poppler_document_new_from_data(char *data, int length, const char *password, GError **error)

G_GNUC_DEPRECATED_FOR(poppler_document_new_from_bytes);

POPPLER_PUBLIC
PopplerDocument *
poppler_document_new_from_bytes(GBytes *bytes, const char *password, GError **error);

POPPLER_PUBLIC
PopplerDocument *
poppler_document_new_from_stream(GInputStream *stream, goffset length, const char *password,
                                 GCancellable *cancellable, GError **error);

POPPLER_PUBLIC
PopplerDocument *
poppler_document_new_from_gfile(GFile *file, const char *password, GCancellable *cancellable,
                                GError **error);
...
POPPLER_PUBLIC
gboolean poppler_document_save_to_fd(PopplerDocument *document, int fd, gboolean include_changes,
                                     GError **error);
...
POPPLER_PUBLIC
gboolean
poppler_document_get_id(PopplerDocument *document, gchar **permanent_id, gchar **update_id);
...
POPPLER_PUBLIC
void poppler_document_get_pdf_version(PopplerDocument *document, guint *major_version,
                                      guint *minor_version);
...
POPPLER_PUBLIC
void
poppler_document_set_creation_date_time(PopplerDocument *document, GDateTime *creation_datetime);
...
POPPLER_PUBLIC
PopplerPSFile *
poppler_ps_file_new(PopplerDocument *document, const char *filename, int first_page, int n_pages);

#ifndef G_OS_WIN32

POPPLER_PUBLIC
PopplerPSFile *
poppler_ps_file_new_fd(PopplerDocument *document, int fd, int first_page, int n_pages);
...
POPPLER_PUBLIC
void poppler_document_sign(PopplerDocument *document, const PopplerSigningData *signing_data,
                           GCancellable *cancellable, GAsyncReadyCallback callback,
                           gpointer user_data);

POPPLER_PUBLIC
gboolean
poppler_document_sign_finish(PopplerDocument *document, GAsyncResult *result, GError **error);
