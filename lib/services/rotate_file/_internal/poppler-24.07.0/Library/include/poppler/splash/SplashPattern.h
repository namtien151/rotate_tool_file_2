...
class POPPLER_PRIVATE_EXPORT SplashSolidColor

: public SplashPattern
{
public:
explicit SplashSolidColor(SplashColorConstPtr
colorA);

SplashPattern *copy() const

override {
return new
SplashSolidColor(color);
}
...
bool getColor(int x, int y, SplashColorPtr c)
...
public:
    ...
    virtual void
    getParametrizedTriangle(int i, double *x0, double *y0, double *color0, double *x1, double *y1,
                            double *color1, double *x2, double *y2, double *color2) = 0;

    virtual void getNonParametrizedTriangle(int i, SplashColorMode mode, double *x0, double *y0,
                                            SplashColorPtr color0, double *x1, double *y1,
                                            SplashColorPtr color1, double *x2, double *y2,
                                            SplashColorPtr color2) = 0;
