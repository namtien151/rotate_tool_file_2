...
public:
    ...
    virtual bool
    checkPageSlice(Page *page, double hDPI, double vDPI, int rotate, bool useMediaBox, bool crop,
    ...
    virtual void initGfxState(GfxState *state) {
        ...
        if (defaultGrayProfile) {
            ...
            cs->buildTransforms(
                    state); // needs to happen after state->setDisplayProfile has been called
    ...
    virtual void
    updateCTM(GfxState * /*state*/, double /*m11*/, double /*m12*/, double /*m21*/, double /*m22*/,
    ...
    virtual bool tilingPatternFill(GfxState * /*state*/, Gfx * /*gfx*/, Catalog * /*cat*/,
                                   GfxTilingPattern * /*tPat*/, const double * /*mat*/, int /*x0*/,
    ...
    virtual bool
    functionShadedFill(GfxState * /*state*/, GfxFunctionShading * /*shading*/) { return false; }

    virtual bool
    axialShadedFill(GfxState * /*state*/, GfxAxialShading * /*shading*/, double /*tMin*/,
                    double /*tMax*/) { return false; }

    virtual bool
    axialShadedSupportExtend(GfxState * /*state*/, GfxAxialShading * /*shading*/) { return false; }

    virtual bool
    radialShadedFill(GfxState * /*state*/, GfxRadialShading * /*shading*/, double /*sMin*/,
                     double /*sMax*/) { return false; }

    virtual bool radialShadedSupportExtend(GfxState * /*state*/,
                                           GfxRadialShading * /*shading*/) { return false; }

    virtual bool
    gouraudTriangleShadedFill(GfxState *state, GfxGouraudTriangleShading *shading) { return false; }

    virtual bool
    patchMeshShadedFill(GfxState *state, GfxPatchMeshShading *shading) { return false; }
    ...
    virtual void
    drawChar(GfxState * /*state*/, double /*x*/, double /*y*/, double /*dx*/, double /*dy*/,
    ...
    virtual bool
    beginType3Char(GfxState * /*state*/, double /*x*/, double /*y*/, double /*dx*/, double /*dy*/,
    ...
    virtual void
    drawImageMask(GfxState *state, Object *ref, Stream *str, int width, int height, bool invert,
                  bool interpolate, bool inlineImg);

    virtual void
    setSoftMaskFromImageMask(GfxState *state, Object *ref, Stream *str, int width, int height,
                             bool invert, bool inlineImg, double *baseMatrix);
    ...
    virtual void drawMaskedImage(GfxState *state, Object *ref, Stream *str, int width, int height,
                                 GfxImageColorMap *colorMap, bool interpolate, Stream *maskStr,
                                 int maskWidth, int maskHeight, bool maskInvert,
                                 bool maskInterpolate);

    virtual void
    drawSoftMaskedImage(GfxState *state, Object *ref, Stream *str, int width, int height,
                        GfxImageColorMap *colorMap, bool interpolate, Stream *maskStr,
    ...
    virtual void
    type3D1(GfxState * /*state*/, double /*wx*/, double /*wy*/, double /*llx*/, double /*lly*/,
    ...
    std::unordered_map<std::string, ProfileData> *
    getProfileHash() const { return profileHash.get(); }
    ...
    virtual void beginTransparencyGroup(GfxState * /*state*/, const double * /*bbox*/,
                                        ...
                                        bool /*knockout*/, bool /*forSoftMask*/) {}
    ...
    PopplerCache<Ref, GfxICCBasedColorSpace> *
    getIccColorSpaceCache() { return &iccColorSpaceCache; }
