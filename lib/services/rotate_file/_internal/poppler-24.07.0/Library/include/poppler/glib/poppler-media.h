 ...
 * Since: 0.14
 */
typedef gboolean(*PopplerMediaSaveFunc)
(
const gchar *buf, gsize
count,
...
POPPLER_PUBLIC
gboolean poppler_media_save_to_callback(PopplerMedia *poppler_media, PopplerMediaSaveFunc save_func,
